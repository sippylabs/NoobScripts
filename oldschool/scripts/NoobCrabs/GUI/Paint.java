...
public class Paint extends ClientAccessor implements PaintListener {
    ...
    public Paint(ClientContext ctx, long start) {
        super(ctx);
        this.start = start;
    }
    ...
    public void repaint(Graphics g1) {
        ...
        String timeRunning = String.format("%02d", hoursRunning) + ":"
        ...
        g.setFont(font2);
        g.drawString("Status: ", 23, 48);
        g.drawString("Timer: " + timeRunning, 23, 73);
